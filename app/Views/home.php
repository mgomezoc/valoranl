...
<body>
    ...
    <section class="cs_hero cs_style_1">
        <div class="container">
            <div class="cs_hero_content_wrapper cs_center_column cs_bg_filed cs_radius_25" data-src="assets/img/hero_img_1.jpg">
            ...
            <div class="cs_features_content_wrapper">
                <div class="row">
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="property-grid.html" aria-label="Click to visit all property" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <span class="cs_iconbox_icon cs_center cs_mb_31">
                                <img src="assets/img/icons/house_icon.svg" alt="House Icon">
                            </span>
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="property-grid.html" aria-label="Click to visit all property" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <span class="cs_iconbox_icon cs_center cs_mb_31">
                                <img src="assets/img/icons/apartment_icon.svg" alt="Appartment Icon">
                            </span>
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="property-grid.html" aria-label="Click to visit all property" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <span class="cs_iconbox_icon cs_center cs_mb_31">
                                <img src="assets/img/icons/villa_icon.svg" alt="Vill Icon">
                            </span>
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="property-grid.html" aria-label="Click to visit all property" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <span class="cs_iconbox_icon cs_center cs_mb_31">
                                <img src="assets/img/icons/bunglo_icon.svg" alt="Bunglow Icon">
                            </span>
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="property-grid.html" aria-label="Click to visit all property" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <div class="cs_iconbox_icon cs_center cs_accent_color cs_mb_31">
                                <img src="assets/img/icons/townhouse_icon.svg" alt="Townhouse Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="property-grid.html" aria-label="Click to visit all property" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <span class="cs_iconbox_icon cs_center cs_mb_31">
                                <img src="assets/img/icons/loft_icon.svg" alt="Loft Icon">
                            </span>
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="property-grid.html" aria-label="Click to visit all property" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <span class="cs_iconbox_icon cs_center cs_mb_31">
                                <img src="assets/img/icons/office_icon.svg" alt="Office Icon">
                            </span>
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn">
                        <a href="#" aria-label="More Category Link" class="cs_iconbox cs_style_1 cs_white_bg cs_radius_15 cs_hover_3 text-center">
                            <span class="cs_iconbox_icon cs_center cs_mb_31">
                                <img src="assets/img/icons/more_icon.svg" alt="Plus Icon">
                            </span>
                                    ...
                                    <div class="cs_slider_wrapper">
                                                ...
                                                <div class="cs_card_content">
                                                    <div class="cs_card_text cs_mb_16">
                                                        <h3 class="cs_card_title cs_fs_28 cs_semibold cs_body_font cs_mb_10">
                                                            <a href="property-details.html" aria-label="Click to visit property details">Beach View Villa</a>
                                                        </h3>
                                        ...
                                        <div class="cs_slide">
                                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                                ...
                                                <div class="cs_card_content">
                                                    <div class="cs_card_text cs_mb_16">
                                                        <h3 class="cs_card_title cs_fs_28 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Shangri la New Apartment Unit</a></h3>
                                                    ...
                                                    <div class="cs_card_btns_wrapper">
                                                        ...
                                                        <a href="phttps://dreamwell-laravel.embexel.com/property-details" aria-label="Click to visit property details" class="cs_card_btn cs_center cs_accent_bg cs_white_color cs_radius_7">
                                                            <span><i class="fa-solid fa-arrow-right"></i></span>
                                                            <span><i class="fa-solid fa-arrow-right"></i></span>
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="cs_slide">
                                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                                ...
                                                <div class="cs_card_content">
                                                    <div class="cs_card_text cs_mb_16">
                                                        <h3 class="cs_card_title cs_fs_28 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Single Family Ranch House</a></h3>
                                        ...
                                        <div class="cs_slide">
                                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                                ...
                                                <div class="cs_card_content">
                                                    <div class="cs_card_text cs_mb_16">
                                                        <h3 class="cs_card_title cs_fs_28 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Northern Apartment</a></h3>
                                        ...
                                        <div class="cs_slide">
                                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                                <a href="property-details.html" aria-label="Click to visit property details" class="cs_card_thumbnail cs_radius_20">
                                                    <img src="assets/img/card_img_5.jpg" alt="Card Image">
                                                </a>
                                                <div class="cs_card_content">
                                                    <div class="cs_card_text cs_mb_16">
                                                        <h3 class="cs_card_title cs_fs_28 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">The Cowboy Country House</a></h3>
    ...
    <section class="cs_tabs cs_style_2">
        <div class="container">
            <div class="cs_section_heading cs_style_1 text-center">
                    ...
                    <div class="row cs_row_gap_20 cs_gap_y_28">
                        <div class="col-xxl-3 col-md-6 wow fadeInUp">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">The Cowboy Country House</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                        ...
                        <div class="col-xxl-3 col-md-6 wow fadeInUp" data-wow-delay="150ms">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                <a href="phttps://dreamwell-laravel.embexel.com/property-details" aria-label="Click to visit property details" class="cs_card_thumbnail cs_radius_20">
                                    <img src="assets/img/card_img_6.jpg" alt="Card Image">
                                </a>
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="phttps://dreamwell-laravel.embexel.com/property-details" aria-label="Click to visit property details">Blue Seagull Beach House</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                        ...
                        <div class="col-xxl-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">East Tower Apartment</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                        ...
                        <div class="col-xxl-3 col-md-6 wow fadeInUp" data-wow-delay="450ms">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">High Rise Apartment</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                        ...
                        <div class="col-xxl-3 col-md-6 wow fadeInUp">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Gilliard Office Building</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                        ...
                        <div class="col-xxl-3 col-md-6 wow fadeInUp" data-wow-delay="150ms">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Silica Townhouse</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                        ...
                        <div class="col-xxl-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Jackhammer Countryside House</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                        ...
                        <div class="col-xxl-3 col-md-6 wow fadeInUp" data-wow-delay="450ms">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Central City Apartment</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                    ...
                    <div class="row cs_row_gap_20 cs_gap_y_28">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="cs_card cs_style_1 cs_white_bg cs_radius_15 position-relative">
                                ...
                                <div class="cs_card_content">
                                    <div class="cs_card_text cs_mb_16">
                                        <h3 class="cs_card_title cs_fs_30 cs_semibold cs_body_font cs_mb_10"><a href="property-details.html" aria-label="Click to visit property details">Blue Seagull Beach House</a></h3>
                                        <p class="cs_card_subtitle cs_fs_14 cs_mb_18">
                                            <i class="fa-solid fa-location-dot"></i>Queensland, Australia
                                        </p>
                                        <ul class="cs_card_features_list cs_mp_0">
                ...
                <div class="cs_working_process_wrapper">
                    <div class="cs_iconbox cs_style_2 cs_center_column position-relative">
                        <span class="cs_iconbox_icon cs_center cs_accent_bg cs_radius_50 cs_mb_20 wow fadeInLeft">
                            <img src="assets/img/icons/user_icon.svg" alt="User Icon">
                        </span>
                    ...
                    <div class="cs_iconbox cs_style_2 cs_center_column position-relative">
                        <span class="cs_iconbox_icon cs_center cs_accent_bg cs_radius_50 cs_mb_20 wow fadeInLeft">
                            <img src="assets/img/icons/house_visit_icon.svg" alt="House Icon">
                        </span>
                    ...
                    <div class="cs_iconbox cs_style_2 cs_center_column position-relative">
                        <span class="cs_iconbox_icon cs_center cs_accent_bg cs_radius_50 cs_mb_20 wow fadeInLeft">
                            <img src="assets/img/icons/contract_icon.svg" alt="Contract Icon">
                        </span>
                    ...
                    <div class="cs_iconbox cs_style_2 cs_center_column position-relative">
                        <span class="cs_iconbox_icon cs_center cs_accent_bg cs_radius_50 cs_mb_20 wow fadeInLeft">
                            <img src="assets/img/icons/key_handover_icon.svg" alt="Home Key Icon">
                        </span>
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="cs_slide">
                            <div class="cs_card_wrapper">
                                <a href="property-grid.html" aria-label="Click to visit all property" class="cs_card cs_style_2 cs_radius_15 text-center position-relative">
                                    <div class="cs_card_overlay cs_heading_bg position-absolute"></div>
                                    <div class="cs_card_thumbnail cs_radius_15">
                                        <img src="assets/img/city_2.jpg" alt="Jakarta City Image">
                                    </div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_card_wrapper">
                                <a href="property-grid.html" aria-label="Click to visit all property" class="cs_card cs_style_2 cs_radius_15 text-center position-relative">
                                    <div class="cs_card_overlay cs_heading_bg position-absolute"></div>
                                    <div class="cs_card_thumbnail cs_radius_15">
                                        <img src="assets/img/city_3.jpg" alt="Jakarta City Image">
                                    </div>
                                    <div class="cs_card_info">
                        ...
                        <div class="cs_slide">
                            <div class="cs_card_wrapper">
                                <a href="property-grid.html" aria-label="Click to visit all property" class="cs_card cs_style_2 cs_radius_15 text-center position-relative">
                                    <div class="cs_card_overlay cs_heading_bg position-absolute"></div>
                                    <div class="cs_card_thumbnail cs_radius_15">
                                        <img src="assets/img/city_4.jpg" alt="London City Image">
                                    </div>
                                    <div class="cs_card_info">
                        ...
                        <div class="cs_slide">
                            <div class="cs_card_wrapper">
                                <a href="property-grid.html" aria-label="Click to visit all property" class="cs_card cs_style_2 cs_radius_15 text-center position-relative">
                                    <div class="cs_card_overlay cs_heading_bg position-absolute"></div>
                                    <div class="cs_card_thumbnail cs_radius_15">
                                        <img src="assets/img/city_5.jpg" alt="Jakarta City Image">
                                    </div>
                                    <div class="cs_card_info">
                        ...
                        <div class="cs_slide">
                            <div class="cs_card_wrapper">
                                <a href="property-grid.html" aria-label="Click to visit all property" class="cs_card cs_style_2 cs_radius_15 text-center position-relative">
                                    <div class="cs_card_overlay cs_heading_bg position-absolute"></div>
                                    <div class="cs_card_thumbnail cs_radius_15">
                                        <img src="assets/img/city_6.jpg" alt="Jakarta City Image">
                                    </div>
                                    <div class="cs_card_info">
                        ...
                        <div class="cs_slide">
                            <div class="cs_card_wrapper">
                                <a href="property-grid.html" aria-label="Click to visit all property" class="cs_card cs_style_2 cs_radius_15 text-center position-relative">
                                    <div class="cs_card_overlay cs_heading_bg position-absolute"></div>
                                    <div class="cs_card_thumbnail cs_radius_15">
                                        <img src="assets/img/city_1.jpg" alt="Jakarta City Image">
                                    </div>
                                    <div class="cs_card_info">
    ...
    <!-- End CTA Section -->
    <!-- Start Blog Section -->
    <section class="cs_blog_area position-relative">
        <div class="cs_height_120 cs_height_lg_80"></div>
        <div class="container">
            <div class="cs_section_heading cs_style_1 text-center">
            ...
            <div class="row cs_row_gap_20 cs_gap_y_30">
                <div class="col-lg-4 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0s">
                    <article class="cs_post cs_style_1 cs_white_bg cs_radius_15">
                        <a href="blog/detail.html" aria-label="Click To Read More" class="cs_post_thumbnail">
                            <img src="assets/img/post_img_1.jpg" alt="Post Image">
                        </a>
                        <div class="cs_post_content">
                            <h3 class="cs_post_title cs_fs_28 cs_semibold cs_body_font cs_mb_13"><a href="blog/detail.html" aria-label="Click to read post">Investment on Property, Profitable or Detrimental?</a></h3>
                            ...
                            <a href="blog/detail.html" aria-label="Click to read post" class="cs_post_btn cs_accent_color cs_medium text-decoration-underline">Read Post</a>
                        </div>
                    </article>
                </div>
                <div class="col-lg-4 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                    <article class="cs_post cs_style_1 cs_white_bg cs_radius_15">
                        ...
                        <div class="cs_post_content">
                            <h3 class="cs_post_title cs_fs_28 cs_semibold cs_body_font cs_mb_13"><a href="blog/detail.html" aria-label="Click to read post">5 Tips on Choosing Comfortable Housing for Families</a></h3>
                            <div class="cs_post_meta_wrapper cs_mb_12">
                                <div class="cs_post_meta">
                                    <span><i class="fa-solid fa-circle-user"></i></span>
                                    <span>Dreamwell Team</span>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".6s">
                    <article class="cs_post cs_style_1 cs_white_bg cs_radius_15">
                        ...
                        <div class="cs_post_content">
                            <h3 class="cs_post_title cs_fs_28 cs_semibold cs_body_font cs_mb_13"><a href="blog/detail.html" aria-label="Click to read post">5 Most Comfortable Areas for Living Space in London</a></h3>
                            <div class="cs_post_meta_wrapper cs_mb_12">
                                <div class="cs_post_meta">
                                    <span><i class="fa-solid fa-circle-user"></i></span>
                                    <span>Dreamwell Team</span>
                    ...
                    <div class="cs_accordians_wrapper cs_style_1 cs_radius_15">
                        <div class="cs_accordian cs_style_1 cs_white_bg">
                            ...
                            <div class="cs_accordian_body">
                                <p>It depends on the context of the situation. If there is a bidding process for a product or service and a price has been listed, then it may be possible to bid on that price. However, if the price listed is a fixed price for a product or service without a bidding process, then it may not be possible to bid on that price.</p>
                            </div>
                        </div>
